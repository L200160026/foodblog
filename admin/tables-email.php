<?php
    ...
    if (!$_SESSION) {
        ...
        if ($_SESSION['Admin_Halaman'] == 'SufeeAdmin') {
            ...
            $kueri = "SELECT ID_Email, Nama, Subject, Message, Tanggal
            FROM Akun, Email WHERE Akun.ID_Akun=Email.ID_Akun ORDER BY Tanggal DESC";
            ...
            try {
                ...
                if (!$result) {
                    ...
                    if ($_GET) {
                        if ($_GET['hapus']) {
                            $id = $_GET['hapus'];
                            $teks = "DELETE FROM Email WHERE ID_Email = '$id' ";
                            $do = mysqli_query($link, $teks);
                            echo"
                                <script>
                                    document.location = 'tables-email.php';
                                </script>
                            ";
                        }
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Table Email</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td><?php echo $value['ID_Email'] ;?></td>
                                            <td><?php echo $value['Nama'] ;?></td>
                                            <td><?php echo $value['Subject'] ;?></td>
                                            <td><?php echo $value['Message'] ;?></td>
                                            <td><?php echo $value['Tanggal'] ;?></td>
                                            <td>
                                                <a href="tables-email.php?hapus=<?php echo $value['ID_Email'];?>" onclick="return confirm('Yakin ingin menghapusnya?')">
