<?php
    ...
    if (!$_SESSION) {
        ...
        if ($_SESSION['Admin_Halaman'] == 'SufeeAdmin') {
            ...
            $kueri = "
            SELECT ID_Komentar, Nama, Judul, Komentar, Komentar.Tanggal 
            FROM Komentar, Akun, Resep
            WHERE Komentar.ID_Akun = Akun.ID_Akun
            AND Komentar.ID_Resep = Resep.ID_Resep";
            ...
            try {
                ...
                if (!$result) {
                    ...
                    if ($_GET) {
                        if ($_GET['ubah']) {
                            $id = $_GET['ubah'];
                            $txt = "SELECT * FROM Komentar WHERE ID_Komentar = '$id' ";
                            $jalan = mysqli_query($link, $txt);
                            $hasil = mysqli_fetch_assoc($jalan);
                        } elseif ($_GET['hapus']) {
                            $id = $_GET['hapus'];
                            $teks = "DELETE FROM Komentar WHERE ID_Komentar = '$id' ";
                            $do = mysqli_query($link, $teks);
                            echo"
                                <script>
                                    document.location = 'tables-komentar.php';
                                </script>
                            ";
                        }
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Table Komentar</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="tables-komentar.php?hapus=<?php echo $value['ID_Komentar'];?>" onclick="return confirm('Yakin ingin menghapusnya?')">
